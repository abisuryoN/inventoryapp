...
public class ChartBarang {
    ...
    public static void tampilChart(JPanel panel) {
        ...
        JFreeChart chart = ChartFactory.createLineChart(
                "Grafik Barang Masuk vs Barang Keluar", // TITLE
                "Hari",                                // X
                "Jumlah",                              // Y
                dataset
        );
        ...
        // WARNA GARIS
        renderer.setSeriesPaint(0, new Color(34,197,94));   // HIJAU
        renderer.setSeriesPaint(1, new Color(239,68,68));   // MERAH
